	...
	<body>
		<div id='main-content'>
			<div id='header'>
				...
				<b style='font-size:15px;'>PEMERINTAH KOTA JAMBI</b>
				<br>
				<b style='font-size:15px;'>DINAS PENDIDIKAN</b>
				<br>
				<b style='font-size:20px;'>Yayasan Pelita Raya Jambi</b>
				<br>
				<div style='font-size:13px';>
					JL. Kopral Ramli, No. 89, Kel.Talang Bakung, Pasir Putih, Kec. Jambi Sel., Kota Jambi, Jambi 36135
				</div>
				<br>
				<b>KOTA JAMBI</b>
				<br>
