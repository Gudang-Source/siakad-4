...
if (isset($_SESSION['siswa']['id_siswa']) && isset($_SESSION['siswa']['pass']) && isset($_SESSION['token'])) {
    ...
    <div class="container">
      <div id="login-box" class="login">
        ...
        <div class="box-content">
          ...
          ?>
          <p>
            <a href="#" data-toggle="modal" data-target="#lost-password">Saya mengalami Lupa Password </a>
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" name="lost" class="btn btn-primary" id="lost">Kirim permintaan </button>
          </div>
          <?php //echo close_form(); ?>
        </div>
      </div>
    ...
    if ($ceknow != 0) {
      ...
      if ($cekpass === TRUE) {
        ...
        if ($jenis == "Guru Mapel" || $jenis == "Guru" && $wk == 1) {
          ...
          @$_SESSION['siswa']['id_card']= $data->id_card;
          ...
          echo "<script>sweetAlert('Oops!', 'Maaf! Hanya siswa saja yang diperbolehkan login!', 'error');</script>";
          echo notice(0);
        }
