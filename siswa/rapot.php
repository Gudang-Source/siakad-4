...
<head>
	<meta charset="UTF-8">
	<title>Rapot Kurikulum 2020</title>
</head>
<style>
	*{
		margin: 0;
	...
	<div id="identitas">
		<table border="0" cellspacing="0"  style="font-size:13.5px !important;">
			<tr>
				...
				<td colspan="4">: Yayasan SMK Pelita Raya</td>
				<td colspan="2">Kelas</td>
				<td>: <?= $exs->rombel; ?></td>
			</tr>
			<tr>
				<td colspan="2">Alamat Sekolah</td>
				<td colspan="4">:JL. Kopral Ramli, No. 89, Kel.Talang Bakung, Pasir Putih, Kec. Jambi Sel., Kota Jambi, Jambi 36135</td>
