				...
				<div class="col-md-6">
					<table class="table table-bordered">
						<tr>
							<td>Nama Sekolah</td>
							<td>:</td>
							<td>Yayasan SMK Pelita Raya</td>
						</tr>
						<tr>
							<td>Alamat Sekolah</td>
							<td>:</td>
							<td>JL. Kopral Ramli, No. 89, Kel.Talang Bakung, Pasir Putih, Kec. Jambi Sel., Kota Jambi, Jambi 36135</td>
						</tr>
						<tr>
					...
					<?php endwhile; ?>
						...
						<?php
							while ($b = mysqli_fetch_object($wjb)) :
								...
								//For knowledge description
								$sqldespb = select("*", "tbl_deskripsi_pth", "kode_mapel = '$b->kode_mapel' AND predikat = '$rap->p_predikat' AND semester = '$sms'");
