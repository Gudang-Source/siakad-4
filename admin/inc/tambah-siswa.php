...
$sqlkode  = select('MAX(id_card)', 'tbl_siswa');
...
<div class="col-md-12">
  ...
  <div class="col-md-6">
    <?php
      ...
      echo label('id_card', 'id card ');
      echo input('number', 'id_card', "class='form-control'")."<br>";
...
if (isset($_POST['submit'])) {
  ...
  if (empty(trim($nama)) || empty(trim($kelas)) || empty(trim($nama)) ||  empty(trim($jk)) ) {
    echo "
    <script>
