    ...
    <div class="col-md-8">
      <div id="select">
        <form class="form-group" action="<?= base('admin/result-nilai'); ?>" method="post">
          ...
          <input type="submit" name="submit" value=" Masukan Nilai" class="btn btn-primary">
        </form>
      </div>
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          <ul class="list-group">
            ...
            <li class="list-group-item">3. Kemudian <strong>Klik</strong> tombol  <strong>Masukan nilai</strong></li>
